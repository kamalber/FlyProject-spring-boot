 ...
 */
package com.weberfly.util.opensource.classifiers;
...
import com.weberfly.util.opensource.features.FeatureExtraction;
import com.weberfly.util.opensource.features.TextTokenizer;
    ...
    private List<Document> preprocessDataset(Map<String, String[]> trainingDataset) {
        ...
        while(it.hasNext()) {
            ...
            for(int i=0;i<examples.length;++i) {
                ...
                //System.out.println("category :"+category+", example :"+examples[i]);
