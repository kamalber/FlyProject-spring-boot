...
import com.weberfly.util.opensource.dataobjects.FeatureStats;
...
public class FeatureExtraction {
    ...
    public FeatureStats extractFeatureStats(List<Document> dataset) {
        ...
        for(Document doc : dataset) {
          //  System.out.println("document "+dataset);
            ...
            for(Map.Entry<String, Integer> entry : doc.tokens.entrySet()) {
                ...
                featureCategoryCounts = stats.featureCategoryJointCount.get(feature);// return count of featur sachant qulle est positive or negative 
                ...
                stats.featureCategoryJointCount.get(feature).put(category, ++featureCategoryCount);
                  // System.out.println("feature: "+category+", feature: "+feature+", featurs count"+featureCategoryCount);
            }
        }
