  ...
  return function(elCanvas, opts, events){
    ...
    var resetCropHost=function() {
      if(image!==null) {
        ...
        elCanvas.prop('width',canvasDims[0]+60).prop('height',canvasDims[1]+60).css({'margin-left': -canvasDims[0]/60+'px', 'margin-top': -canvasDims[1]/60+'px'});

        theArea.setX(ctx.canvas.width/2);
        theArea.setY(ctx.canvas.height/2);
        theArea.setSize(Math.min(200, ctx.canvas.width, ctx.canvas.height));
      } else {
